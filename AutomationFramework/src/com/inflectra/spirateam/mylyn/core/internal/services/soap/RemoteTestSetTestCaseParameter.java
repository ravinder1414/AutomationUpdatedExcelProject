...
@XmlType(name = "RemoteTestSetTestCaseParameter", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", propOrder = {
    "name",
    "value"
})
public class RemoteTestSetTestCaseParameter {
    ...
    @XmlElementRef(name = "Value", namespace = "http://schemas.datacontract.org/2004/07/Inflectra.SpiraTest.Web.Services.v3_0.DataObjects", type = JAXBElement.class)
