 ...
 * 
 */
@WebServiceClient(name = "ImportExport", targetNamespace = "http://www.inflectra.com/SpiraTest/Services/v4.0/", wsdlLocation = "file:/c:/Subversion/Projects/RemoteLaunch/Trunk/Cross-Platform/RemoteLaunch-X/src/com/inflectra/remotelaunch/services/ImportExport40.wsdl")
public class ImportExport
    extends Service
{

    private final static URL IMPORTEXPORT_WSDL_LOCATION;
    private final static Logger logger = Logger.getLogger(com.inflectra.remotelaunch.services.soap.ImportExport.class.getName());
    ...
    static
    {
        ...
        try {
            URL baseUrl;
            baseUrl = com.inflectra.remotelaunch.services.soap.ImportExport.class.getResource(".");
            url = new URL(baseUrl, "file:/c:/Subversion/Projects/RemoteLaunch/Trunk/Cross-Platform/RemoteLaunch-X/src/com/inflectra/remotelaunch/services/ImportExport40.wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'file:/c:/Subversion/Projects/RemoteLaunch/Trunk/Cross-Platform/RemoteLaunch-X/src/com/inflectra/remotelaunch/services/ImportExport40.wsdl', retrying as a local file");
